...
const FlexContent = ({ifExists, endpoint: { title, heading, text,
img, btn, url} }) => {
  return (
    <>
         ...
         lg:justify-items-center'>
            ...
            <a href={url} className='flex items-center'
             target={"_blank"} role='button'>
                ...
                bg-slate-900 shadoww-slate-900 text-slate-100
                py-1.5'>{btn}</button>
            </a>
        </div>

        <div className='flexe items-center justify-center max-w-xl
        relative lg:max-w-none w-full'>
            <img 
            src={img}
            alt={`img/${heading}`}
