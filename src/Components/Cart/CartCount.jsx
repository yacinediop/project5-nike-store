      ...
      px-3 sticky top-0 left-0 right-0 w-full'>
        ...
        <div className='flex items-center accent-pink-300 gap-3'>
          ...
          <div className='grid items-center cursor-pointer' onClick={onCartToggle}>
            <ChevronDoubleLeftIcon className='w-5 h-5 teext-slate-900
            hover:text-orange-500 stoke-[2]'/>
          </div>


          <div className='grid items-center '>

            <h1 className='text-base font-medium text-slate-900'>Your Cart <span className='bg-theme-cart rounded px-1 py-0.5 text-slate-100
            font-normal text-xs'>(Items)</span></h1>
          </div>
